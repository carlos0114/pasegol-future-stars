    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-navy/95 backdrop-blur-md border-b border-primary/10">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button className="px-5 py-2 rounded-lg bg-cta-gradient text-navy font-semibold text-sm hover:opacity-90 transition-opacity">
            Crear Perfil Gratis
          </button>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-navy border-t border-primary/10 px-4 py-4 space-y-3 animate-fade-in">
          ...
          <button className="w-full px-5 py-2 rounded-lg bg-cta-gradient text-navy font-semibold text-sm">
            Crear Perfil Gratis
          </button>
        </div>
      )}
